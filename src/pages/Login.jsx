      ...
      <div className="w-full max-w-md">
        ...
        <div className="backdrop-blur-xl bg-white/80 dark:bg-slate-900/80 p-8 rounded-3xl shadow-2xl border border-white/20">
          <div className="text-center mb-8">
            ...
            <p className="text-xs text-indigo-600 dark:text-indigo-400 mt-1 font-medium">AI-powered platform for smarter learning</p>
          </div>
          ...
          <form onSubmit={onSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center text-gray-600 dark:text-gray-400 cursor-pointer group">
                <input type="checkbox" className="w-4 h-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500 transition-all cursor-pointer" />
                <span className="ml-2 group-hover:text-indigo-500 transition-colors">Remember me</span>
              </label>
              <Link to="/forgot-password" title="Feature coming soon" className="text-indigo-600 hover:text-indigo-500 font-medium transition-colors">Forgot Password?</Link>
            </div>
          ...
          <p className="mt-8 text-center text-gray-600 dark:text-gray-400">
            ...
            <Link to="/register" className="text-indigo-600 hover:text-indigo-500 font-bold transition-colors underline decoration-2 underline-offset-4">
              Register Now
            </Link>
          </p>
        </div>
